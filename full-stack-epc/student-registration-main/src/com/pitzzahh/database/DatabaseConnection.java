...
//            throw new StudentNotFoundException();
            ignored.printStackTrace(); // This will tell you the REAL error (like "Table not found")
        }
    }
    ...
    public Student getStudent(String studentNumber) {
        try {
            ...
            ResultSet resultSet = conn.createStatement().executeQuery(GET_ROW_QUERY.apply(studentNumber));
            if (resultSet.next()) {
                return new Student(
                        resultSet.getString("student_number"),
                    resultSet.getString("name"),
            ...
            sqlException.printStackTrace(); // This will tell you the REAL error (like "Table not found")
//            throw new StudentNotFoundException();
        }
        return null;
    }
