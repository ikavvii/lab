...
--8 Show employees whose name starts with ï¿½Mï¿½.
...
--12 Show details of employees whose names contain the letter ï¿½aï¿½ (case-insensitive).
...
--18 Show employees whose name ends with ï¿½nï¿½.
